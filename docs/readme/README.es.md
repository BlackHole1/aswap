...
| [Refrescar el uso bajo demanda](../../patches/feat_add_a_refresh_command_that_fetches_usage_now_one_account_at_a_time.patch)                            | Tras un 429 del endpoint de uso, `ls` muestra cifras de hace una hora sin forma de volver a pedirlas. `cswap refresh [cuenta ...]` consulta ahora, cada cuenta por separado, e indica cuándo el servidor permite reintentar.                                                     |

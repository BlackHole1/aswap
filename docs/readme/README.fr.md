...
| [Rafraîchir l'usage à la demande](../../patches/feat_add_a_refresh_command_that_fetches_usage_now_one_account_at_a_time.patch)                     | Après un 429 de l'endpoint usage, `ls` affiche des chiffres vieux d'une heure sans moyen de redemander. `cswap refresh [compte ...]` interroge maintenant, chaque compte indépendamment, et indique quand le serveur autorise un nouvel essai.                              |
